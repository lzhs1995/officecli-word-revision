...
- For the RUC doctoral-thesis profile, apply the explicit table alignment rule: every table paragraph has first-line and hanging indent 0; Han-dominant content is right-aligned; Latin/digit-dominant statistical content is left-aligned; mixed explanatory cells follow Han/right. Re-run the validator after Word round-trip and inspect the Word PDF.
